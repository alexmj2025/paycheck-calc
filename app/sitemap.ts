...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${BASE}/blog/how-to-read-your-pay-stub`,
      lastModified: new Date('2026-04-28'),
      changeFrequency: 'yearly',
      priority: 0.75,
    },
    {
      url: `${BASE}/blog/how-to-fill-out-w4-2026`,
      lastModified: new Date('2026-04-28'),
      changeFrequency: 'yearly',
      priority: 0.75,
    },
    {
      url: `${BASE}/blog/effective-vs-marginal-tax-rate`,
      lastModified: new Date('2026-04-28'),
      changeFrequency: 'yearly',
      priority: 0.75,
    },
    {
      url: `${BASE}/blog/pretax-deductions-guide`,
      lastModified: new Date('2026-04-28'),
      changeFrequency: 'yearly',
      priority: 0.75,
    },
    {
      url: `${BASE}/blog/fica-tax-explained`,
      lastModified: new Date('2026-04-28'),
      changeFrequency: 'yearly',
      priority: 0.75,
    },
